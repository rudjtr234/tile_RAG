...
chroma_client = PersistentClient(
    path="/home/mts/ssd_16tb/member/jks/tile_RAG_data/vectorDB/tile_RAG_embedding_db_v0.4.0"
)
collection = chroma_client.get_or_create_collection(name="tile_embeddings_UNI2")
